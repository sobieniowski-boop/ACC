...
def aggregate_gls_order_logistics(
    *,
    ...
    try:
        ...
        if job_id:
            set_job_progress(job_id, progress_pct=20, records_processed=0, message=f"GLS logistics aggregate count={len(rows)}")
        ...
        for idx, row in enumerate(rows, start=1):
            payload = {
                ...
                "calc_version": "gls_v1",
                "source_system": "shipment_aggregate_gls",
            }
            ...
            if idx % 100 == 0:
                ...
                if job_id:
                    ...
                    set_job_progress(
                        ...
                        message=f"GLS logistics aggregate processed={idx}/{len(rows)}",
                    )
        ...
        if job_id:
            set_job_progress(
                ...
                message="GLS logistics aggregate finished",
            )
        return stats
    finally:
        conn.close()
...
def build_gls_logistics_shadow(
    *,
    ...
    try:
        ...
        if job_id:
            set_job_progress(job_id, progress_pct=20, records_processed=0, message=f"GLS logistics shadow count={len(rows)}")
            ...
            if idx % 200 == 0:
                ...
                if job_id:
                    ...
                    set_job_progress(
                        ...
                        progress_pct=min(pct, 95),
                        records_processed=idx,
                        message=f"GLS logistics shadow processed={idx}/{len(rows)}",
                    )
        ...
        if job_id:
            set_job_progress(
                ...
                message="GLS logistics shadow finished",
            )
        return stats
    finally:
        conn.close()
